...
class CategoryGroupController extends Controller {
    ...
    public function __construct(CategoryGroup $categoryGroup, ProductCategory $productCategory, CategoryGroupHasCategories $categoryGroupHasCategories)
    {
        $this->module = "product";
        $this->moduleTitle = "Category Groups";
        $this->modulePath = "category-groups";
    ...
    public function index($id = null)
    {
        ...
        $allData = $this->data->where('is_boomstick_category', 1)->with('have_main_categories')->orderBy('id', 'DESC')->get();
    ...
    public function post_add(CategoryGroupRequest $request)
    {
        ...
        $this->data->status = 1;
        $this->data->is_boomstick_category = 1;
        $this->data->save();
        $dataId = $this->data->id;
    ...
    public function get_delete($id)
    {
        ...
        if($data->have_main_categories){
            foreach ($data->have_main_categories as $row) {
                $row->delete();
            }
        }
