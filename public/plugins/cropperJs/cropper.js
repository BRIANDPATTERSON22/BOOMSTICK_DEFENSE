...
var methods = {
  ...
  getData: function getData$$1() {
    ...
    // alert(data.x+" "+data.y+" "+data.width+" "+data.height+" "+data.rotate+" "+data.scaleX+" "+data.scaleY);
    return data;
  },
  ...
  getCroppedCanvas: function getCroppedCanvas() {
    ...
    var _getData = this.getData(),
        ...
        alert("width: "+x+ " height: "+y+" initial width"+_getData.width+" initial height"+_getData.height);
