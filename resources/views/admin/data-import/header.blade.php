...
@if(count($errors)>0)
    <div class="alert alert-danger" style="border-radius: 0px;margin-bottom: 0px;"><strong>Whoops!</strong> There were some problems with your input!
        ...
        <ul class="dropdown-menu">
            ...
            @foreach($years as $year)
                <li class="text-capitalize">
                    <a href="{{ url('admin/'.$module.'s/archive/'.$year) }}"> {{$module}}(s) created in the Year {{$year}}</a>
                </li>
            @endforeach
        </ul>
    </li> --}}
