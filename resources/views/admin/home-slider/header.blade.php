...
<ul class="nav nav-tabs">
    ...
    @yield('actions')
    <li class="@if(Request::is('*trash')) active @endif pull-right"><a href="{{URL::to('admin/'.$module.'s/trash')}}" class="text-muted" title="Deleted Items"><i class="fa fa-trash-o"></i> @if(Request::is('*/'.$module.'s')) ({{$deleteCount}}) @endif</a></li>
</ul>