@if(count($errors)>0)
    <div class="alert alert-danger"><strong>Whoops!</strong> There
...
<ul class="nav nav-tabs">
    <li @if(Request::is('*import*')) class="active" @endif><a href="{{url('admin/import/category')}}"><i class="fa fa-list"></i> <span>Manage</span></a></li>

    {{-- <li @if(Request::is('*add')) class="active" @endif><a href="{{url('admin/'.$module.'/add')}}"><i class="fa fa-plus"></i> <span>Add</span></a></li> --}}

    {{-- <li @if(Request::is('admin/import/category')) class="active" @endif><a href="{{url('admin/import/category')}}"><i class="fa fa-plus"></i> <span>Categories</span></a></li> --}}
