                            ...
                            @foreach ($allData as $row)
                                ...
                                <tr class="@if($row->status==0) disabledBg @endif">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('admin/'.$module.'/'.$row->id.'/view')}}">
                                          @if($row->main_image)
                                              <img class="card-img-top img-fluid" src="{{asset('storage/products/images/'.$row->main_image)}}" alt="{!!$row->title!!}"  height="50px">
                                          @else
                                               <img class="card-img-top img-fluid" src="{{asset('site/defaults/product_placeholder.png')}}" alt="{!!$row->title!!}"  height="50px">
                                          @endif
                                        </a>
                                    </td>
                                    <td>
                                  ...
                                  {{--   <td class="text-left">
                                    ...
                                    <td class="text-left">
                                        {{$option->currency_symbol}}{{number_format($row->sale_price,2)}}
                                    </td>
