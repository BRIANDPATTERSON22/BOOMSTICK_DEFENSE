                                                ...
                                                @foreach ($allData as $row)
                                                    ...
                                                    <tr class="@if($row->status==0) disabledBg @endif">
                                                        ...
                                                        <td  style="white-space: nowrap;">
                                                            <a href="{{ url('admin/shipping/'.$row->id.'/edit')}}" class="btn btn-sm btn-warning"> <i class="fa fa-edit"> </i></a>
                                                            <a href="{{ url('admin/shipping/'.$row->id.'/delete')}}" onclick="if(!confirm('Are you sure to delete this data?')){return false;}" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"> </i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
