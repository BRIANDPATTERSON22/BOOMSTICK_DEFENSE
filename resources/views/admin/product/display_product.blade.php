...
@section('main-content')
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    {!!Form::select('products[]', $productsData, null, ['class' => 'form-control select2', 'multiple' => 'multiple','data-placeholder' => 'Select the product(s)'])!!}
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li class="{{ Request::is('admin/display-type/featured') ? 'active' : '' }}"><a href="{{ url('admin/display-type/featured') }}" data-toggle="tab_"><i class="fa fa-bookmark"></i> <span>Featured Products</span></a></li>
            <li class="{{ Request::is('admin/display-type/new') ? 'active' : '' }}"><a href="{{ url('admin/display-type/new') }}" data-toggle="tab_"><i class="fa fa-cube"></i> <span>New Arrivals</span></a></li>
            {{-- <li class="pull-right">
                <a href="{{url('admin/shippings')}}"><i class="fa fa-plus"></i> <span>Add</span></a>
            </li> --}}
        </ul>
        <div class="tab-content">
            @if(Request::is('admin/display-type/featured'))
            <div class="tab-pane {{ Request::is('admin/display-type/featured') ? 'active' : '' }}" id="tab_1">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box-body">
                            <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($featuredProductsData as $row)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="label label-default">{{ $row->product ? $row->product->title : 'Product Deleted' }} </span> &nbsp
                                                            </td>
            ...
            @if(Request::is('admin/display-type/new'))
            <div class="tab-pane {{ Request::is('admin/display-type/new') ? 'active' : '' }}" id="tab_2">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box-body">
                            <div class="row">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('select[name="type"]').on('change', function(){
                ...
                if(typeId) {
                    $.ajax({
                        url: APP_URL+'/admin/get-product-by-type/'+typeId,
                        type:"GET",
                        dataType:"json",
                        beforeSend: function(){
