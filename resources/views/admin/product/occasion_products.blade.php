                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="box-header">
                            <h3 class="box-title">
                                @if($singleData->id) Edit sub category type ID: {{$singleData->id}} @else  Add New occasion product @endif
                            </h3>
                        </div>
                        <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->has('sub_category_id') ? 'has-error' : '' }}">
                                ...
                                {!!Form::select('sub_category_id', $subCategories, null, ['class' => 'form-control select2', 'placeholder' => 'Select a sub category'])!!}
                    ...
                    <div class="col-md-9">
                        <div class="box-header">
                            <h3 class="box-title">List of occasion products</h3>
                            <small class="pull-right">
                                <a href="{{url('admin/occasion-product')}}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add</a>
                            </small>
                        </div>
                        <div class="box-body">
...
{{--                                             <td>{!!$row->slug!!}</td>
                                            ...
                                            <td>
                                                <a href="{{ url('admin/occasion-product/'.$row->id.'/edit')}}" class="btn btn-sm btn-warning"> <i class="fa fa-edit"> </i></a>
                                                <a href="{{ url('admin/occasion-product/'.$row->id.'/delete')}}" onclick="if(!confirm('Are you sure to delete this data?')){return false;}" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"> </i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
