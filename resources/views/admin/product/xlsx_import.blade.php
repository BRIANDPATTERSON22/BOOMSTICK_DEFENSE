    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                ...
                <div>
                {!!Form::open(['url' => 'admin/products/zip-import', 'files' => true])!!}
                {!!csrf_field()!!}
                <div class="row">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="col-sm-3 form-group">
                                    {!!Form::label("Upload file (.zip) *")!!}
                                    {!!Form::file('zip_file', null, ['class' => 'form-control'])!!}
                                    <em class="help-info">{!!$errors->first('zip_file')!!}</em>
                                </div>
                            </div>
                        </div>              
                    </div>
                ...
                <div class="box-footer">
                    <button type="submit" class="btn btn-success" name="zip_submit"><i class="fa fa-check-circle-o"></i> Upload</button>
                    <a class="btn btn-default" href="{{url('admin/'.$module.'s/xlsx-import')}}"><i class="fa fa-times-circle-o"></i> Cancel </a>
                </div>
                {!!Form::close()!!}
                </div>
