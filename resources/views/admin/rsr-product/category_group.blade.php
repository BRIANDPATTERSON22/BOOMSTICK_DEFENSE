                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <select name="categories[]" class="form-control select2" multiple="multiple" data-placeholder="Select Categories">
                                        @foreach($mainCategoriesCollection as $row)
                                            <option value="{{ $row->department_id }}" @if($singleData->id && in_array($row->department_id, $singleData->categories)) selected @endif>
                                                {{ $row->department_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                            ...
                                            <table id="dataTable" class="table table-hover">
                                                ...
                                                @foreach ($allData as $row)
                                                    ...
                                                    <tr class="@if($row->status==0) disabledBg @endif">
                                                        ...
                                                        <td>
                                                            @foreach ($row->have_rsr_main_categories as $category) 
                                                                <span class="label label-default">
                                                                    {{ $category->has_rsr_main_category ? $category->has_rsr_main_category->department_name : "x Deleted x" }}
                                                                </span> &nbsp;
                                                            @endforeach
                                                        </td>
