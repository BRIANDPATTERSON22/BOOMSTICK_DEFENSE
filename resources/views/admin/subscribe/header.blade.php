...
<ul class="nav nav-tabs">
    <li @if(Request::is('admin/subscribes')) class="active" @endif>
        <a href="{{url('admin/subscribes')}}"><i class="fa fa-list"></i> <span>Manage</span></a>
    </li>
    ...
    <li class="@if(Request::is('*trash')) active @endif pull-right">
        <a href="{{url('admin/subscribes/trash')}}"><i class="fa fa-trash-o"></i> <span>Deleted</span> @if(Request::is('admin/subscribes')) ({{$deleteCount}}) @endif</a>
    </li>
    @yield('actions')
</ul>