        ...
        <div class="row">
            <div class="col">
                <div class="breadcrumb-contain">
                    <div>
                        <h2> Guest Checkout Address</h2>
                        <ul>
                            <li><a href="{{ url('/') }}">home</a></li>
                            <li><i class="fa fa-angle-double-right"></i></li>
                            <li><a>Guest Checkout Address</a></li>
                        </ul>
                    </div>
                </div>
            </div>
              ...
              <div class="col-lg-8 mx-auto">
                 ...
                 {{-- <div class="card">
                  ...
                  <div class="theme-card">
                      ...
                      {!!Form::model( session('guestAddressSession') ?? null, ['autocomplete'=>'off', 'id' => 'guest_checkout_address_form', 'class' => 'theme-form'])!!}
                      {!!csrf_field()!!}
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              <label class="d-inline text_transform_none">
...
@section('page-script')
  ...
  <script>
    ...
    {{-- <script type="text/javascript">
        $( document ).ready(function() {
            $('#guest_checkout_address_form').submit(function(){
                $("#id_submit_btn", this)
