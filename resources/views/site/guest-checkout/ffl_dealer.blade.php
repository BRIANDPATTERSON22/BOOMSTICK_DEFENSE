...
@section('htmlheader_title')
    Guest Checkout FFL Dealers | Shop
@endsection
        ...
        <div class="row">
            <div class="col">
                <div class="breadcrumb-contain">
                    <div>
                        <h2> Guest Checkout FFL Dealer </h2>
                        <ul>
                            <li><a href="{{ url('/') }}">home</a></li>
                            <li><i class="fa fa-angle-double-right"></i></li>
                            <li><a>Guest Checkout FFL Dealers</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                  ...
                  <div class="theme-card">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-12">
                          <label for="id_ffl_dealers" class="control-label">Available FFL Dealers *</label>
                          {{-- @php
