...
@section('page-style')
    <style>
        .card {background-color: #1a1a1a;margin-bottom: 1.25rem;}
...
@section('main-content')
                              ...
                              <div class="card-body">
                                <div class="table-responsive table-sm">
                                  <table class="table table-condensed">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td class="text-left w-40">Billing Address</td>
                                        <td class="text-left">{{Session::get('guestAddressSession')['billing_address']}}</td>
                                      </tr>
                                     {{--  <tr>
                                        <td class="text-left w-40">Billing country</td>
                                ...
                                @if(Session::get('isSameAsBillingSession') == 1)
                                  <div class="table-responsive table-sm">
                                    <table class="table table-condensed">
                                      ...
                                      <tbody>
                                        <tr>
                                          <td class="text-left w-40">Delivery Address</td>
                                          <td class="text-left">{{Session::get('guestAddressSession')['billing_address']}}</td>
                                        </tr>
                                       {{--  <tr>
                                          <td class="text-left w-40">Billing country</td>
                                        ...
                                        <tr>
                                          <td class="text-left w-40">Delivery city</td>
                                          <td class="text-left">{{ Session::get('guestAddressSession')['billing_city']}}</td>
                                        </tr>
                                        <tr>
                                          <td class="text-left w-40">Delivery state</td>
                                          <td class="text-left">{{ Session::get('guestAddressSession')['billing_state']}}</td>
                                        </tr>
                                        <tr>
                                          <td class="text-left w-40">Delivery postal code</td>
                                          <td class="text-left">{{ Session::get('guestAddressSession')['billing_postal_code']}}</td>
                                        </tr>
                                      </tbody>
                                    </table>
                              ...
                              @else
                                  <div class="table-responsive table-sm">
                                    <table class="table table-condensed">
                                      ...
                                      <tbody>
                                        <tr>
                                          <td class="text-left w-40">Address</td>
                                          <td class="text-left">{{Session::get('guestAddressSession')['delivery_address']}}</td>
                                        </tr>
                                     {{--    <tr>
                                          <td class="text-left w-40">Delivery country</td>
                            ...
                            <div class="card-body">
                              <div class="table-responsive table-sm">
                                  <table class="table table-condensed">
                                      ...
                                      <tbody>
                                          <tr>
                                              <td class="text-left w-40">Shpping Method</td>
                                              {{-- <td class="text-left">{{ $mainShippingMethod }} - {{$shippingServiceName}}</td> --}}
                                              <td class="text-left">{{$shippingServiceName}}</td>
                                          </tr>
                                      </tbody>
                                  </table>
                              </div>
                            ...
                            <div class="card-body">
                              <div class="table-responsive table-sm">
                                  <table class="table table-condensed">
                                      ...
                                      <tbody>
                                          <tr>
                                              <td class="text-left w-40">Payment Method</td>
  ...
  <div class="modal fade " id="shippingModel" tabindex="-1" aria-labelledby="shippingModalLabel" aria-hidden="true">
      <div class="modal-dialog">
          {!!Form::model(null, ['url'=>'shipping-methods', 'autocomplete'=>'off', 'id' => 'guest_checkout_shipping_form', 'class' => 'theme-form'])!!}
          {!!csrf_field()!!}
          <div class="modal-content  bg-dark">
            <div class="modal-header">
  ...
  <div class="modal fade " id="paymentModel" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
      <div class="modal-dialog">
          {!!Form::model(null, ['url'=>'payment-methods', 'autocomplete'=>'off', 'id' => 'guest_checkout_payment_form', 'class' => 'theme-form'])!!}
          {!!csrf_field()!!}
          <div class="modal-content  bg-dark">
            <div class="modal-header">
