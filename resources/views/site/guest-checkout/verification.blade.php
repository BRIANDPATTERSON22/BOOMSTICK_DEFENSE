...
@section('htmlheader_title')
    Guest Checkout Age Verification | Shop
@endsection
        ...
        <div class="row">
            <div class="col">
                <div class="breadcrumb-contain">
                    <div>
                        <h2> Guest Checkout Verification </h2>
                        <ul>
                            <li><a href="{{ url('/') }}">home</a></li>
                            <li><i class="fa fa-angle-double-right"></i></li>
                            <li><a>Guest Checkout Verification</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                  ...
                  <div class="theme-card">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-outline-dark btn-sm float-left" href="{{url('remove-products')}}">
                              <i class="icon-arrow-left"></i>
