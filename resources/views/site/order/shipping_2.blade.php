                    ...
                    <div class="theme-card">
                        ...
                        {{-- @if (session('addressValidationSession') && count($rating) > 0) --}}
                            <div class="checkout_form_inner inno_shadow p-3 b_0 mb-4">
                                {!!Form::open(['url'=> 'checkout-shipping', 'autocomplete'=>'off', 'name' => 'shipping_form'])!!}
                                {!!csrf_field()!!}
                                ...
                                <input type="hidden" name="sub_shipping_method_service_name" id="subShippingServiceName">
                                  ...
                                  <h3 class="text-center">Select a Shipping Method <span class="pull-right">{{-- {{ Session::get('totalWeightSesssion') }} LBS --}}</span></h3> 
                                  {{-- UPS --}}
                                  @if (count($rating) > 0)
                   ...
                   @include('site.partials.flash_message')
                    <div class="theme-card">
                        ...
                        <div class="d-flex justify-content-between paddin-top-1x mt-4">
                            <a class="btn btn-theme-round btn-lg" href="{{url('checkout-address')}}"><i class="icon-arrow-left"></i><span class="hidden-xs-down">&nbsp;Back</span></a>
                            @if (count($shippingData) > 0)
                                <button type="submit" class="btn btn-theme-round btn-lg pull-right cursor-pointer">
                                    <span class="hidden-xs-down">Continue&nbsp;</span><i class="icon-arrow-right"></i>
                                </button>
                            @endif
                        </div>
