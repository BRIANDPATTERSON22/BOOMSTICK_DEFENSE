        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 mx-auto">
                <div class="error_form inno_shadow p_30">
                    ...
                    <h2 class="font-weight-bold">Thank you for your order!</h2>
                    <p>
                      Your order has been placed and will be processed as soon as possible. Make sure you make note of your order number, which is <span class="text-medium font-weight-bold">{{ $orderNo }}</span> You will be receiving an email shortly with confirmation of your order.
                    </p>
