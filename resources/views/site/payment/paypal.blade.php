                                ...
                                onApprove: function(data, actions) {
                                    ...
                                    return actions.order.capture().then(function(details) {
                                        ...
                                        if(details.status == 'COMPLETED'){
                                            return fetch(APP_URL + '/paypal-status', {
                                                  method: 'post',
                                                  headers: {
                                              ...
                                              .then(function(response){
                                                  ...
                                                  window.location.href = APP_URL + '/order-completed';
                                              })

                                              .catch(function(error) {
                                                console.log(error);
                                                  // redirect to failed page if internal error occurs
                                                  window.location.href = APP_URL + '/order-cancelled?reason=internalFailure';
                                              });
                                          }else{
                                              window.location.href = APP_URL + '/order-cancelled?reason=failedToCapture';
                                          }
                                    });
                                },
