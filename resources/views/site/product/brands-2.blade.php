                            ...
                            <div class="product-item">
                               ...
                               <div class="product-item-image">
                                  {{-- <span class="like-icon"><a href="shop-grid-full.html#"> <i class="icofont icofont-heart"></i></a></span> --}}
                                   @if($row->image)
                                  <a href="{{url('brand/'.$row->slug)}}"><img class="card-img-top img-fluid" src="{{asset('storage/brands/'.$row->image)}}" alt=""></a>
                                  @else
                                   <a href="{{url('brand/'.$row->slug)}}"><img class="card-img-top img-fluid" src="{{asset('site/images/default.png')}}" alt=""></a>
                                  @endif
                               </div>
                               <div class="product-item-body">
                                  <div class="product-item-action">
                                     ...
                                     <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="{{url('brand/'.$row->slug)}}" data-original-title="View Detail"><i class="icofont icofont-search-alt-2"></i></a>
                                  </div>
                                  <h4 class="card-title"><a href="shop-grid-full.html#">{{str_limit($row->name, 20)}}</a></h4>
                                  <h5>
                                     {{-- <span class="product-desc-price">{{ count($row->subCategories) }}</span> --}}
                                     {{-- <span class="product-price">$10</span> --}}
                                     <span class="product-discount">{{ count($row->products) }} Products</span>
                                  </h5>
                               </div>
