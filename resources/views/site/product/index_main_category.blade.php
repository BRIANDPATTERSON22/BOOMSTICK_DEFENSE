                  ...
                  <div class="breadcrumb-contain">
                      <div>
                          ...
                          <ul>
                            ...
                            <li><a href="{{ url('main-categories') }}">Categories</a></li>
                            <li><i class="fa fa-angle-double-right"></i></li>
                            <li><a>{{ get_main_category_name(request()->slug) }}</a></li>
                          </ul>
                      </div>
                  </div>
              </div>
      ...
      <div class="collection-wrapper">
          <div class="custom-container">
              <div class="row">
                                                         ...
                                                         <input type="hidden" name="to_price" value="{{ request()->to_price }}">
                                                          ...
                                                          <div class="product-page-per-view">
                                                              <select name="products_per_page" onchange="this.form.submit()">
                                                                  ...
                                                                  <option value="96" @if(request()->products_per_page == 96) selected @endif>96 Products Per Page</option>
                                                              </select>
                                                          </div>
                                                                ...
                                                                <div class="product-front">
                                                                        ...
                                                                        @if($row->image_name)
                                                                          @if (Storage::exists($row->get_lr_image_storage_path_by_category()))
                                                                            <img class="img-fluid" src="{{asset($row->get_lr_image_by_category())}}">
                                                                          @else
                                                                            <img class="img-fluid" src="{{asset('site/defaults/image-coming-soon.png')}}">
                                                                          @endif
                                                                        @else
                  ...
                  @include('site.product.sidebar_main_category')
